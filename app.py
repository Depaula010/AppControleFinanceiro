...
def setup_database():
    """ 
    Cria/Recria a ESTRUTURA final do banco (v11).
    *** CORREÇÃO: Removido CHECK (valor >= 0) da Transacoes ***
    """
    ...
    CREATE TABLE Transacoes ( 
        ...
        valor NUMERIC(15, 2) NOT NULL, -- <-- CORREÇÃO: Removido CHECK (valor >= 0)
...
def populate_global_categories():
    ...
    if not engine: return "Erro: Banco não configurado.", 500; sql_populate_dml = text("""..."""); # Script DML omitido
