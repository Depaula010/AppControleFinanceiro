...
# Importa o motor (assumindo que motor_agendamentos.py está na mesma pasta)
try:
    ...
    def processar_agendamentos():
        print("ERRO: 'motor_agendamentos.py' não encontrado.")
...
try:
    ...
    try:
        ...
        print("[AVISO] Locale 'pt_BR.UTF-8' ou 'Portuguese_Brazil.1252' não encontrados. Usando locale padrão.")
...
if GEMINI_API_KEY:
    ...
    print("AVISO: Chave do Gemini não configurada.")
    model = None
...
if DATABASE_URL:
    ...
    print("AVISO: URL do Banco de Dados não configurada.")
    engine = None

# ========= 2. ROTAS ADMINISTRATIVAS (Com Sintaxe 'except' Corrigida) =========
...
# ========= 4. ENDPOINTS PRINCIPAIS (Com 'except' Corrigido) =========

@app.route('/')
def home():
    return "API do Bot Financeiro v13 (Format R$) está no ar!"
...
def handle_whatsapp_webhook():
    ...
    *** CORRIGIDA: Verificação de resposta vazia do Gemini E sintaxe do 'except' ***
    ...
    try:
        ...
        Classifique a intenção principal como "Renda", "Despesa", "Transferência", "Pagamento Fatura", "Consulta Potes", ou "Consulta Reserva".
