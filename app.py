...
def setup_database():
    """ 
    Cria/Recria a ESTRUTURA final do banco (v11 com api_key). 
    Execute PRIMEIRO.
    """
    ...
    CREATE TABLE Usuarios (
        ...
        api_key_automate VARCHAR(100) NULL UNIQUE, -- <<< CAMPO ADICIONADO
    ...
    CREATE TABLE Transacoes ( 
        ...
        valor NUMERIC(15, 2) NOT NULL, -- <-- Permite valores negativos
    ...
    try:
        with engine.connect() as conn:
            ...
            conn.commit() 
        return "Estrutura final do banco (v11 com api_key) criada/recriada com sucesso!", 200
...
def populate_global_categories():
    ...
    BEGIN;
    -- Limpa apenas os templates, deixa os dados do usuário
...
def setup_user_data():
    ...
    Execute TERCEIRO.
    *** ELA GERA E RETORNA SUA API KEY DO AUTOMATE ***
    """
    if not engine: return "Erro: Banco não configurado.", 500
    ...
    nova_api_key = secrets.token_hex(20) # Gera 40 caracteres hexadecimais
    ...
    DO UPDATE SET 
        nome = EXCLUDED.nome,
        api_key_automate = EXCLUDED.api_key_automate -- Atualiza a chave!
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            user_data = result.fetchone() # Pega a linha (id, api_key_automate)
            if user_data:
                user_id = user_data[0]
                api_key_retornada = user_data[1]
            else:
                # Se o ON CONFLICT não retornou, busca manualmente
        ...
        # Retorna a chave para você copiar!
        return jsonify({
            "status": "sucesso",
